...
const Card = ({ data }) => {
  ...
  return (
    <div className="card m-5 cursor-pointer" >
      <Link href={`/product/${data.id}`}>
       
          <div className="image flex justify-center  rounded-xl mb-3">
          ...
          <div className="text-group flex-wrap">
            ...
            {data.rating && (
              <div className="flex text-center items-center gap-3">
                ...
                <p className="text-sm font-normal">{data.rating.rate}/5</p>
              </div>
            )}
            <p className="flex text-2xl font-bold">${data.price}</p>
          </div>
